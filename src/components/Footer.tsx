            ...
            <div className="md:flex md:justify-between">
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <ul className="text-gray-600 dark:text-gray-400">
                            <li className="mb-4">
                                <a href="https://github.com/ytalotech" className="hover:underline ">Github</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                ...
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M21.1314 0.712646H2.37651C1.51713 0.712646 0.81889 1.42065 0.81889 2.2898V21.0105C0.81889 21.8796 1.51713 22.5876 2.37651 22.5876H21.1314C21.9908 22.5876 22.6939 21.8796 22.6939 21.0105V2.2898C22.6939 1.42065 21.9908 0.712646 21.1314 0.712646ZM7.43022 19.4626H4.18803V9.02319H7.4351V19.4626H7.43022ZM5.80912 7.59741C4.76908 7.59741 3.92924 6.75269 3.92924 5.71753C3.92924 4.68237 4.76908 3.83765 5.80912 3.83765C6.84428 3.83765 7.68901 4.68237 7.68901 5.71753C7.68901 6.75757 6.84916 7.59741 5.80912 7.59741V7.59741ZM19.5835 19.4626H16.3414V14.3845C16.3414 13.1736 16.3169 11.616 14.6568 11.616C12.9673 11.616 12.7085 12.9343 12.7085 14.2966V19.4626H9.46635V9.02319H12.5767V10.449H12.6206C13.0552 9.62866 14.1148 8.7644 15.6919 8.7644C18.9732 8.7644 19.5835 10.9275 19.5835 13.74V19.4626V19.4626Z" fill="#878484" />
                        </svg>
                    ...
                    <a href="https://github.com/ytalotech" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
